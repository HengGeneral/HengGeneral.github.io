...
HBase配置文件, 文件中定制了HBase的配置(默认配置可查看[hbase-default.xml][hbase-default]), 具体涉及到的如下:
...
```
    ...
    <!-- 指定region server的共享目录，用来持久化HBase -->
    <property>
...
还有一些其他的配置说明, 参见[配置][hbase-config]。
...
[hbase-default]: https://github.com/apache/hbase/blob/master/hbase-common/src/main/resources/hbase-default.xml

[hbase-config]: http://hbase.apache.org/book.html#config.files
